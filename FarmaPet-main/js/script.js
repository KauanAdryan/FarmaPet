...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const dropdownCadastros = document.querySelector('.dropdown-cadastros');

  // Adicionar evento de clique ao botão
  btnCadastros.addEventListener('click', function(e) {
    e.stopPropagation(); // Impede que o clique se propague
    dropdownCadastros.classList.toggle('show');
  });

  // Fechar o dropdown quando clicar em qualquer lugar fora
  document.addEventListener('click', function() {
    dropdownCadastros.classList.remove('show');
  });

  // Impedir que o dropdown feche quando clicar nele
  dropdownCadastros.addEventListener('click', function(e) {
    e.stopPropagation();
  });
});
